...
- O frontend deve expor apenas uma caixa livre para comando, sem formulario guiado por campos.
...
- O card tera uma unica caixa livre, exemplos clicaveis e botao de executar.
...
- `POST /api/varreduras` inicia um job a partir do comando livre.
